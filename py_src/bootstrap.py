...
def bootstrap():
    ...
    inj.bind(cluster.featurization.Featurizer,
        to = cluster.featurization.basic_featurize.TfFeaturizer)
    ...
    inj.bind(cluster.feature_selection.FeatureSelector,
        to = cluster.feature_selection.InformationGainSelector)
    ...
    inj.bind_instance(getty.Config,
        with_annotation = 'min_features', to = 400)
    inj.bind_instance(getty.Config,
        with_annotation = 'max_mass_ratio', to = 0.4)
    inj.bind_instance(getty.Config,
