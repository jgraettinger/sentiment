#ifndef FEATURE_TRANSFORM_INFORMATION_GAIN_STATISTIC_HPP
#define FEATURE_TRANSFORM_INFORMATION_GAIN_STATISTIC_HPP

#include "feature_transform/maximum_likelihood_mixin.hpp"
